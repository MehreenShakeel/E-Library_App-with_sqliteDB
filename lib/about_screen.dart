                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 20),
                      const Text(
                        'This library management app was created to simplify book and member management.',
                        textAlign: TextAlign.center,
                      ...
                      const ListTile(
                        ...
                        subtitle: Text(
                          'Get help instantly with our AI chatbot.',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                      const SizedBox(height: 20),
                      ...
                      const SizedBox(height: 10),
                      const Text(
                        'Large book collection, intuitive interface, fast support.',
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                    ],
